...
export async function GET(request:Request){
  ...
  target.search=new URLSearchParams({client_id:appId,redirect_uri:"https://fattasha.vercel.app/api/auth/facebook/callback",state,scope:"public_profile",response_type:"code"}).toString();
